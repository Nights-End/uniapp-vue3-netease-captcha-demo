require("./../../runtime"), require("./../../common"), (swan.neCaptchaJsonp = swan.neCaptchaJsonp || []).push([[7], {
  19: function (t, e, a) {
    "use strict";
        ...
        handlePointTap: (i = p(d.default.mark(function t(e) {
          ...
          return d.default.wrap(function (t) {
            for (;;) switch (t.prev = t.next) {
              ...
              case 11:
                return i = this.data.loadInfo.data.token, r = e.changedTouches[0], o = r.clientX, c = r.clientY, t.next = 15, this.getImgRect();
        ...
        handleTrackMoving: (n = p(d.default.mark(function t(e) {
          ...
          return d.default.wrap(function (t) {
            for (;;) switch (t.prev = t.next) {
              ...
              case 5:
                n = t.sent, i = n.left, r = n.top, o = e.changedTouches[0], c = o.clientX, u = o.clientY, h = (0, s.xor_encode)(a, [Math.round(c - i), Math.round(u - r), Date.now() - this.beginTime] + ""), this.setData({
