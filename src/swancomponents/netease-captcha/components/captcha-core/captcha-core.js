import { createAnimation as _helpers$createAnimation } from "../../adaptor.js";
require("./../../runtime"), require("./../../common"), (swan.neCaptchaJsonp = swan.neCaptchaJsonp || []).push([[3], {
  21: function (t, a, e) {
    "use strict";
    ...
    Component({
      ...
      created: function () {
        var t = _helpers$createAnimation();
